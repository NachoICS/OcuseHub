...
<title>Reservas y Cliente</title>
<!-- TemplateEndEditable -->
<style type="text/css">
<!--
body {
...
<!-- TemplateBeginEditable name="head" --> editable del head
<!-- TemplateEndEditable -->
</head>
...
<p></p>
  ...
  <div class="content">
    ...
    <div><!-- TemplateBeginEditable name="Editable del Body" -->Zona Editable del body 
	
	ACA VAN LOS CONTENIDOS DE LAS VISTA. 
