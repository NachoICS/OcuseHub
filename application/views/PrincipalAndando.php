...
<br></br>
			...
			<div class="row">
				<div class="col-md-4">
				<!-- <img alt="Bootstrap Image Preview" src="../assets/Imagenes/avion.jpg" />
				-->
				</div>
				<div class="col-md-4">
   ...
   <input type="text" class="form-control" placeholder="" />
						    ...
						    <p>  <span class="label label-info">FECHA</span> <input type="date" name="fecha"/> </p>
							 ...
							 <p>  <span class="label label-info">PLAZA</span> <select name = "energia"> 
		<option>  </option>
		...
		<option> Turista</option>
						 ...
						 <p>  <span class="label label-info">CANTIDAD</span> <select name = "energia"> 
