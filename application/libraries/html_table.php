...
function Header()
{
	...
	$this->SetTextColor(160,196,254);
	//$imagen = $this->Image('../images/AutomotorMarcaAgua',60,30,90,0,'PNG');
	
	$this->RotatedText(15,50,'../images/escuditoDos.jpg',360);
//	$this->RotatedText(140,50,'../images/esudoAgua.png',360);
	//	$this->RotatedText(15,100,'../images/esudoAgua.png',360);
	//$this->RotatedText(140,100,'../images/esudoAgua.png',360);
//		$this->RotatedText(15,150,'../images/esudoAgua.png',360);
	//$this->RotatedText(140,150,'../images/esudoAgua.png',360);
}
...
function RotatedText($x, $y, $txt, $angle)
{
	...
	//$this->Image($txt,$cx,$cy,'','','','','N','',''); 
	//$this->SetAlpha(1,'NORMAL');
	$this->Image($txt,65,30,'','','','','N','','');
	$this->Image($txt,200,30,'','','','','N','',''); 
	 
	$this->Image($txt,65,85,'','','','','N','',''); 
	$this->Image($txt,200,85,'','','','','N','','');  
	
	$this->Image($txt,65,128,'','','','','N','',''); 
	$this->Image($txt,200,128,'','','','','N','','');  
	//$this->Image($txt,180,128,'','','','','N','','');
